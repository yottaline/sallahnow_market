...
class MarketSubcategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.subcategories.index', compact('categories'));
    }
    ...
    public function load(Request $request)
    {
        ...
        if($request->f_category) $params[] = ['category_name',   'like', '%' . $request->f_category . '%'];

        echo json_encode(Market_subcategory::fetch(0, $params, $limit, $lastId));
    }
