    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="POST" action="/subcategories/submit">
                    @csrf
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name_ar" required
                                    data-ng-value="updateSubCategory !== false ? jsonParse(list[updateSubCategory].subcategory_name).ar : ''"
                                    id="subcategoryName" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name_en" required
                                    data-ng-value="updateSubCategory !== false ? jsonParse(list[updateSubCategory].subcategory_name).en : ''"
                                    id="subcategoryName" />
                            </div>
                        </div>
