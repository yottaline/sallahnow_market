            ...
            <div class="modal-body">
                <form method="POST" action="/categories/submit">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="categoriesNameAr">
                                    Categiry Name AR<b class="text-danger">&ast;</b></label>
                                <input type="text" class="form-control" name="name_ar" required
                                    data-ng-value=" updateCategory !== false ? jsonParse(list[updateCategory].category_name).ar : ''"
                                    id="categoriesNameAr" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="categoriesNameEn">
                                    Categiry Name EN<b class="text-danger">&ast;</b></label>
                                <input type="text" class="form-control" name="name_en" required
                                    data-ng-value="updateCategory !== false ? jsonParse(list[updateCategory].category_name).en : ''"
                                    id="categoriesNameEn" />
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function categoyreClsForm() {
        $('#CateId').val('');
        $('#categoriesNameAr').val('');
        $('#categoriesNameEn').val('');
    }
</script>
