...
@section('content')
    <div class="container-fluid" data-ng-app="myApp" data-ng-controller="myCtrl">
            ...
            <div class="col-12 col-sm-4 col-lg-3">
                <div class="card card-box">
                    <div class="card-body">
                        {{-- country --}}
                        <div class="mb-3">
                            <label>Category<b class="text-danger">&ast;</b></label>
                            <select id="filter-category" class="form-select">
                                <option value="0">-- SELECT CATEGORY --</option>
                                <option data-ng-repeat="category in categories" data-ng-value="country.location_id"
                                    data-ng-bind="jsonParse(category.category_name)['en']"></option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        @include('content.components.modal.subcaetgories')
        ...
        app.controller('myCtrl', function($scope) {
            ...
            $scope.dataLoader = function(reload = false) {
                ...
                var request = {
                    ...
                    f_category: $('#filter-category').val(),
                    limit: limit,
                    _token: '{{ csrf_token() }}'
                };
